...
class FailurePredictionModel:
    ...
    def save(self, model_path='../datasets/failure_predictor.pkl'):
        """
    ...
    @staticmethod
    def load(model_path='../datasets/failure_predictor.pkl'):
        """
        Load trained model
...
def main():
    ...
    # Save model
    model.save('../datasets/failure_predictor.pkl')
    ...
    print("2. Check feature importance: ../datasets/feature_importance.png")
