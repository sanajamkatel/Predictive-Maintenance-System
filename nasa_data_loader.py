...
class NASADataLoader:
    ...
    def __init__(self, dataset_name='FD001', nasa_folder='NASA Folder'):
        """
    ...
    def add_failure_labels(self, df, failure_threshold=30):
        ...
        print(f"Failure rate with threshold={failure_threshold}: {failure_rate:.2f}%")
    ...
    def save_processed_data(self, df, output_path='data/sensor_data.csv'):
        """
...
def main():
    ...
    dataset_name = input("\nEnter dataset name (default: FD001): ").strip().upper() or 'FD001'
    ...
    loader.save_processed_data(df, output_path='data/sensor_data.csv')
    
    print("\n" + "="*70)
    print("✅ NASA DATA PROCESSING COMPLETE")
    print("="*70)
    print("\nNext steps:")
    print("  1. Review the processed data: data/sensor_data.csv")
